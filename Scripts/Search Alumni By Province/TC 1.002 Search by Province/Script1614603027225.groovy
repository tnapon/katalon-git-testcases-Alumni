...
WebUI.setText(findTestObject('Object Repository/Page_/input__search'), 'ราชบุรี')

WebUI.click(findTestObject('Object Repository/Page_/input__submit'))

WebUI.verifyTextPresent('เฉลิมรัฐ พรมสอาด', false)

WebUI.verifyTextPresent('ธนกฤต ตินพ', false)
