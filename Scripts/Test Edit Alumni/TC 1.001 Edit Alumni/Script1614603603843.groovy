...
WebUI.click(findTestObject('Page_Document/a_ edit'))

WebUI.click(findTestObject('Object Repository/Page_/input_- ()_fname'))

WebUI.setText(findTestObject('Object Repository/Page_/input_- ()_fname'), 'ธนพล ใจตรง')

WebUI.click(findTestObject('Object Repository/Page_/button_'))

WebUI.verifyTextPresent('ธนพล ใจตรง', false)
