...
WebUI.setText(findTestObject('Object Repository/Page_Document/input_- ()_fname'), 'วรพล')

WebUI.setText(findTestObject('Object Repository/Page_Document/input_- ()_ename'), 'คนดี')

WebUI.setText(findTestObject('Object Repository/Page_Document/input_- ()_id'), '1758520135455')
...
WebUI.setText(findTestObject('Object Repository/Page_Document/input__email'), '614259004@webmail.npru.ac.th')

WebUI.setText(findTestObject('Object Repository/Page_Document/input__tel'), '0911169040')

WebUI.setText(findTestObject('Object Repository/Page_Document/input_Facebook_face'), 'Varapon')

WebUI.setText(findTestObject('Object Repository/Page_Document/input_Line ID_line'), 'DEDE')

WebUI.setText(findTestObject('Object Repository/Page_Document/input__homea'), '564')

WebUI.setText(findTestObject('Object Repository/Page_Document/input__mou'), '3')

WebUI.setText(findTestObject('Object Repository/Page_Document/input__song'), '4')
...
WebUI.setText(findTestObject('Object Repository/Page_Document/input__sid'), '614259004')
